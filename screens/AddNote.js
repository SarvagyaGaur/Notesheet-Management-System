...
const AddNote = () => {
  ...
  useEffect(() => {
    const backAction = () => {7
      ...
      Alert.alert("Your notesheet has not been saved.", "Do you want to save it?", [{ text: "Yes", onPress: saveNote }, { text: "No", onPress: navigation.goBack }], { cancelable: true });
      return true;
    }
  ...
  return (
    <View style={{ flex: 1 }}>
      <View style={{ flex: 1, backgroundColor: "#f5f5f5" }}>
        <TextInput value={formData.text} onChangeText={text => handleChange("text", text)} multiline={true} style={{ padding: 20, fontSize: 16, color: "#555" }} placeholder="Write content here.." autoFocus />
      </View>
