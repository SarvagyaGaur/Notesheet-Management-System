...
const Folders = () => {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      {folders.length > 0 && (
        <>
          <Text style={{ color: theme.PRIMARY_COLOR, fontWeight: "600", fontSize: 15, paddingHorizontal: 10, paddingVertical: 20, borderBottomWidth: 1, borderBottomColor: "#efefef" }}>{folders.length} status {folders.length > 1 && 's'}</Text>
